...
int main(int argc, char **argv) {
  ...
  kvserver_init(&follower, follower_name, 4, 4, 2, follower_hostname, follower_port);
  ...
  ret = kvserver_register_leader(&follower, sockfd);
  if (ret < 0) {
